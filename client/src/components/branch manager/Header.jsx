...
const Header = ({ 
  ...
  const branchName = "Midigama Branch"; // Example branch name
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          <div className="text-left hidden md:block">
            <div className="font-medium text-gray-800 dark:text-white text-sm">{userName}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">{branchName}</div>
          </div>
          <ChevronDown 
